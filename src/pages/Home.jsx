  ...
  return (
    <div className="w-full min-h-screen bg-gray-900 text-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1560521166-167baa83205f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTN8fGNoZW1pY2FsJTIwY29tcG5heXxlbnwwfHwwfHx8MA%3D%3D')",
        }}
      >
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition">
              ...
              <h3 className="font-semibold text-xl mb-2">Laboratory Research</h3>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition">
              ...
              <h3 className="font-semibold text-xl mb-2">Industrial Solutions</h3>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition">
              ...
              <h3 className="font-semibold text-xl mb-2">Environmental Safety</h3>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition">
              ...
              <h3 className="font-semibold text-xl mb-2">Research Automation</h3>
            </div>
